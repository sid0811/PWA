...
import {
  // getShopLocationForSync, // PWA: DB functions - to be implemented
  // insertAllData,
...
export const getDataCore = async (options: GetDataOptions) => {
  ...
  // PWA: Shop location sync - to be implemented with database
  // try {
  ...
  // PWA: App log writing - to be implemented with database
  // try {
  ...
  try {
    ...
    try {
      ...
      // PWA: insertAllData to be implemented with database
