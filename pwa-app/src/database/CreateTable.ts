...
export const CreateTable: TableQueries = {
  ...
  Attendance:
    'CREATE TABLE IF NOT EXISTS Attendance(id INTEGER PRIMARY KEY AUTOINCREMENT, UserId TEXT, AttendanceType TEXT, AttendanceDate TEXT, AttendanceTime TEXT, Latitude REAL, Longitude REAL, Remark TEXT, IsDayEnd INTEGER DEFAULT 0, SyncFlag INTEGER DEFAULT 0)',
  UsesLog:
    'CREATE TABLE IF NOT EXISTS UsesLog(id INTEGER PRIMARY KEY AUTOINCREMENT, UserId TEXT, Activity TEXT, DateTime TEXT, SyncFlag INTEGER DEFAULT 0)',
  Setting:
    'CREATE TABLE IF NOT EXISTS Setting(id INTEGER PRIMARY KEY AUTOINCREMENT, Name TEXT UNIQUE, Value TEXT)',
  RO_BankCustomer:
    'CREATE TABLE IF NOT EXISTS RO_BankCustomer(id INTEGER PRIMARY KEY AUTOINCREMENT, PartyCode TEXT, BankName TEXT, AccountNo TEXT, IFSC TEXT, BankBranch TEXT, userid TEXT)',
};
